      ...
      <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="../public/assets/fontend/img/banner1.png" class="d-block w-100" alt="..." height="130">
          </div>
          <div class="carousel-item">
            <img src="../public/assets/fontend/img/banner2.jpg" class="d-block w-100" alt="..." height="130">
          </div>
          <div class="carousel-item">
            <img src="../public/assets/fontend/img/banner3.png" class="d-block w-100" alt="..." height="130">
          </div>
        </div>
